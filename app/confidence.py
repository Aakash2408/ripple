...
def format_pr_body(change_description: str, source_repo: str,
    ...
    body_parts.extend([
        ...
        f"| **Status** | Pushed — not yet merged |",
        "",
        ...
        "|----------|--------|---------|",
        f"| 💻 Code | ✅ Fixed | This file — broken reference removed |",
        f"| 📋 Contract | ℹ️ Source | Upstream spec change (not modified here) |",
        f"| 🧪 Tests | 📝 Review | Check if tests reference `{change_description.split('`')[1] if '`' in change_description else 'changed field'}` |",
        f"| 📝 Docs | 📝 Review | Update API docs if field was documented |",
        f"| 📖 Examples | 📝 Review | Update examples if field was demonstrated |",
        f"| ⚙️ Config | ✅ Safe | No config references detected |",
        "",
