...
export const PRICING = [
  {
    ...
    price: "Free",
    note: "Forever",
    features: ["All 10 contract types", "7 platforms", "Self-hosted agent", "Community support"],
  ...
  },
  {
    ...
    cta: { label: "Open dashboard", href: LINKS.dashboard },
    featured: true,
  },
  {
    name: "Enterprise",
    ...
    cta: { label: "View source", href: LINKS.source },
    featured: false,
  },
];
